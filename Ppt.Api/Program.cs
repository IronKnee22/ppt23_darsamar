...
app.MapGet("/Ukunyinfo/{Id}", (Guid Id, PptDbContext db) =>   /*Pomocí ID získáme z tabulky revizes všechny revize*/
{
...
app.MapPost("/vybaveniUkon/{Id}", (Guid Id, UkonyVM prichoziModel, PptDbContext db) => /*Nové vybavení*/
{
